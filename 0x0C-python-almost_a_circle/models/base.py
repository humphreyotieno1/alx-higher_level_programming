...
class Base:
    ...
    def save_to_file(cls, tosave):
        """Write JSON serialization to a file"""
    ...
    def from_json_string(string):
        """Return from JSON deserialization of a string"""
    ...
    def save_to_file_csv(cls, data):
        """Write CSV serialization of a list of objects"""
    ...
    def load_from_file_csv(cls):
        """Return list of classes instantiated from CSV"""
        filename = cls.__name__ + ".csv"
        sheader = ["id", "size", "x", "y"]
